...
def get_args():
    ...
    parser.add_argument('--modal', default='representation_fusion_subset', type=str, help='which data stream')
...
if __name__ == '__main__':
    ...
    for N in [16, 32, 64, 128, 256]:#, 1024, 2048]: #[4, 16, 64, 256, 1024, 2048]:
        batchsize = min(N, 64)
        cvsubfolder = os.path.join(cvfolder, str(N))
        max_len = 500
        overlap = 128
